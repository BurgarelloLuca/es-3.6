...
int main() {
    int n_prodotti;
    float prezzo_prodotti, prezzo_finale, sconto10, sconto20,sconto_totale, prezzo_non_scontato;
    ...
    if(prezzo_non_scontato<10) {
        ...
        prezzo_finale = prezzo_non_scontato - sconto_totale;
        printf(" il totale scontato e' di %2f",&prezzo_finale);
    }
}
